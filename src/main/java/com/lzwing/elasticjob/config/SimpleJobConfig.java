...
package com.lzwing.elasticjob.config;
...
import com.lzwing.elasticjob.job.simple.JavaSimpleJob;
...
public class SimpleJobConfig {
    ...
    public JobScheduler simpleJobScheduler(
        ...
        return new SpringJobScheduler(
                simpleJob,
                regCenter,
                getLiteJobConfiguration(simpleJob.getClass(), cron, shardingTotalCount, shardingItemParameters), jobEventConfiguration);
    }
